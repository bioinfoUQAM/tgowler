...
public final class WorkflowMatcher {
     ...
     * @return 
     */
    public final boolean tryToMatch(JobBlock firstBlock, int[] appariement, boolean[] modifications, final Workflow sequence, final OntoRepresentation ontology, final Motif m){      
     ...
     * @return 
     */
    public final boolean tryToMatch_BETA(JobBlock firstBlock, int[] appariement, boolean[] modifications, final Workflow sequence, final OntoRepresentation ontology, final Motif m){      
        appariement = this.__match3_beta(firstBlock, appariement, modifications, sequence, ontology, m);        
        return (appariement[0]!=0);
    }
    
    
    public final boolean tryToMatch_with_Output(JobBlock firstBlock, int[] appariement, boolean[] modifications, final Workflow sequence, final OntoRepresentation ontology, final Motif m, StringBuilder html, int[] nbr_steps){
     ...
     * @return 
     */
    public final int[] __match2(JobBlock block, int[] appariement, boolean[] modifications, final Workflow sequence, final OntoRepresentation ontology, final Motif m){
...
//            System.out.println("sequence: " + sequence);
            ...
            if(appariement[block.position] != res) {
                ...
                //if(use_modifs) {
                if(WorkflowMatcher.debug) System.out.println("Need to set modifs to true");
            ...
            if(res>0){
                ...
                //WorkflowMatcher.ascending = true;
                WorkflowMatcher.mode = 2;
    ...
    public final int[] __match3_beta(JobBlock block, int[] appariement, boolean[] modifications, final Workflow sequence, final OntoRepresentation ontology, final Motif m){
        int res;//resultat des jobs
        JobBlock child;//contraintes liees aux relations
        System.out.println("#######################");
        WorkflowMatcher.mode = 0;
    ...
    public final int[] __match_with_output(JobBlock block, int[] appariement, boolean[] modifications, final Workflow sequence, final OntoRepresentation ontology, final Motif m, StringBuilder html, int[] nbr_steps){
        int res;//resultat des jobs
        JobBlock child;//contraintes liees aux relations
        boolean use_modifs=false;
        if(appariement[0]!=0){
            use_modifs=true;
            if(WorkflowMatcher.debug) System.out.println("using modifications...");
        }
        ...
        while(block!=null){
             ...
             */
            if(WorkflowMatcher.html_output){
