...
public final class RadixTree<A>{
    ...
    public Character[] alphabet = new Character[128];
    ...
    public RadixNode<A> splitNode(RadixNode<A> rn, Character[] chars, int where, A o){
        ...
        */
        ...
        /*System.out.println("rn="+Arrays.toString(rn.index));
        System.out.println("first="+Arrays.toString(first.index));
        if(chars.length != 0) System.out.println("second="+Arrays.toString(second.index));
        else System.out.println("chars null no second...");
        System.out.println("where="+where);*/
        /*if(chars.length == 0){
            System.exit(1);
        }*/
        ...
        else return second;//renvoie l'id de second node !
    }
    ...
    public RadixNode<A> addString(char[] chars, A o, boolean ow){
        //System.out.println("inserting "+Arrays.toString(chars));
        //System.out.println("///////////////////////////////////////////");
        ...
        while(test_test>0){
            ...
            /*if(Arrays.equals(chars, "http://www.semanticweb.org/ahmedhalioui/ontologies/2015/7/untitled-ontology-8#DNA".toCharArray())){
            ...
            */            
            ...
            if(id<0){
                ...
                */
                ...
                /*if(ow && test_test<1){
                    System.out.println("LA VALEUR EST DEJA PRESENTE, L'ECRASER?:"+Arrays.toString(n.index));
                ...
                /*if(Arrays.equals(chars, "http://www.semanticweb.org/ahmedhalioui/ontologies/2015/7/untitled-ontology-8#DNA".toCharArray())){
                    System.out.println("decided to do nothing "+(test_test)+" / " +chars.length);
                    System.out.println(">>>"+n.children.get(id).getKey());
        ...
        /*if(Arrays.equals(chars, "http://www.semanticweb.org/ahmedhalioui/ontologies/2015/7/untitled-ontology-8#DNA".toCharArray())){
            System.out.println("returning "+n.getKey());
            System.out.println("but its value is "+n.getValue());
            System.out.println("because has "+n.children.size()+" sons !!! because of a splitNode, current node has no value");
            System.out.println("and we do not override values so the node still indexes nothing => considered as not present...");
            //return n.children.get(id);
        }*/
        return n;
    }
    ...
    public Object get(char[] chars, RadixNode<A> root){
        ...
        while(remaining_chars>0){
            ...
            */
            ...
            if(res[0]>-1&&res[2]!=1){
                ...
                /*if(Arrays.equals(chars, "http://www.semanticweb.org/ahmedhalioui/ontologies/2015/7/untitled-ontology-8#DNA".toCharArray())){
                    System.out.println("found one "+res[0]);
                    //return n.children.get(id);
                }*/
        ...
        if(n.getValue()!=null){
            ...
            /*if(Arrays.equals(chars, "http://www.semanticweb.org/ahmedhalioui/ontologies/2015/7/untitled-ontology-8#DNA".toCharArray())){
                System.out.println("found one but value is null");
                //return n.children.get(id);
            }*/
            return null;
        }
    ...
    public RadixNode<A> getNode(String s, RadixNode<A> root){
        char[] chars = s.toCharArray();
        return this.getNode(chars, root);
    }
    
    public RadixNode<A> getNode(char[] chars, RadixNode<A> root){
        int[] res = new int[4];
        //int test_test = chars.length;
        int remaining_chars = chars.length;//nombre de caracteres restants a matcher
        RadixNode<A> n = root;
    ...
    public final class LinkedRadixNode<A> extends RadixNode implements Iterable{
        ...
        @Override
        public void setValue(Object item) {
            /*if(!(item instanceof AnchoredLinkedList)){
                System.out.println("bad type...");
                System.exit(1);
            }*/
            //this.value = (AnchoredLinkedList<A>) item;
            this.value = new AnchoredLinkedList<>((A)item);
        }
