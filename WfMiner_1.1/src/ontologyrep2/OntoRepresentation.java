 ...
 * @author Enridestroy
 */
public class OntoRepresentation {
    
    //index sur les elements de l'ontologie par noms
    public RadixTree index_concepts_by_name = new RadixTree(RadixTree.SIMPLE_NODES);
    public RadixTree index_relations_by_name = new RadixTree(RadixTree.SIMPLE_NODES);
    public RadixTree index_instances_by_name = new RadixTree(RadixTree.SIMPLE_NODES);
...
//                System.out.println("Parent: "+parent.getName());
    ...
    }//rajouter un depth en parametres.
    //on prend les patterns en profondeur x.
    //refaire un morceau de code qui determine quelle est la profondeur d'un concept
    //et qui l'assigne.
    //rootConcepts devient ConceptsAtDepth[0]...
    ...
    public void addConcept(final String name, final Concept c){
        ...
        //verification...
        if(c.p_name.getKey().length()!=name.length()){
//            System.out.println("concept not same string (key)....");
//            System.out.println(""+name+"");
//            System.out.println(""+c.p_name.getKey());
            System.exit(1);
        }
...
//            System.out.println("not same string....");
    ...
    /**
     * Parents d'une relation
     * @param c
     * @return 
     */
    public ArrayList<Concept> getParents(final Relation r){
//        return this.index_concepts_by_taxonomy.getParentValues(r.p_index);
    ...
    public void addRelation(final String name, Relation r){
        ...
        //verification...
        if(r.p_name.getKey().length()!=name.length()){
//            System.out.println("concept not same string (key)....");
//            System.out.println(""+name+"");
//            System.out.println(""+r.p_name.getKey());
            System.exit(1);
        }
        if(r.getName().length()!=name.length()){
//            System.out.println("not same string....");
            System.exit(1);
        }
    ...
    public void createTripletInst(final Relation r, final Instance c1, final Instance c2){
        ...
        */
        ...
        if(matrix_instances_props[c2.index] == null){
            matrix_instances_props[c2.index] = new int[4000][];
        }
        if(matrix_instances_props[c2.index][c1.index] == null){
            matrix_instances_props[c2.index][c1.index] = new int[50];
        }
     ...
     * 
     * @param subjectConcept Subject of the property.
     * @param objectConcept Object of the property.
     * 
     ...
     * 
     * @param hierarchyConcepts Hierarchy concepts to set.
     */
     ...
     * 
     * @param hierarchyProperties Hierarchy properties to set.
     */
     ...
     * 
     * @param rootConcept Root concept to add.
     */
     ...
     * 
     * @param rootProperty Root property to add.
     */
     ...
     * 
     * @param child Child concept to add.
     ...
     * 
     * @param property The property to add between the concepts.
     * @param subjectConcept The subject concept of the property.
     * @param objectConcept The object concept of the property.
     */
     ...
     * 
     * @param properties The properties to add between the concepts.
     * @param subjectConcept The subject concept of the property.
     * @param objectConcept The object concept of the property.
     */
