...
import ontopattern16.SomeUnsafeStuff;
...
public class VerticalSeqPropDB {
    public static void construire_vpdb(int[] vertical_db, ArrayList<Sequence> all_sequences, int nbr_concepts, 
        ...
        SomeUnsafeStuff.loadUnsafeFast();
        System.out.println("notUsedItemSets="+notUsedItemSets+" => "+(notUsedItemSets/(float)itemset2prop.length));
        System.out.println("notUsedPropsInAllPositions="+notUsedPropsInAllPositions+" => "+(notUsedPropsInAllPositions/(float)(itemset2prop.length*Relation.ID)));
        System.out.println("notUsedBlocks="+notUsedBlocks+" => "+(notUsedBlocks/(float)fatbitmap.length));
        System.out.println("cout de ndx itemsets2props="+(itemset2prop.length * 4)+" bytes, actually="+SomeUnsafeStuff.array_sizeOf(itemset2prop));
        System.out.println("cout de ndx props2bitmap="+(prop2fatbitmap.length * 4)+" bytes, actually="+SomeUnsafeStuff.array_sizeOf(prop2fatbitmap));
        System.out.println("cout du bitmap vertical="+(fatbitmap.length * 4)+" bytes, actually="+SomeUnsafeStuff.array_sizeOf(fatbitmap));
        System.out.println("size of bitmap is "+next_free_block_in_bitmap);
